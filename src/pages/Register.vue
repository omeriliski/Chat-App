...
export default {
  ...
  methods: {
    onSave() {
      ...
      this.userData.color=this.getRandomColor;
      console.log("this.userData",this.userData);
      this.$appAxios
        .post("/users", { ...this.userData, password: cryptedPassword })
        .then((res) => {
          console.log(res);
  ...
  computed:{
      getRandomColor() {
        const colors=["alert-primary","alert-secondary","alert-success","alert-danger","alert-warning","alert-light","alert-dark"]
